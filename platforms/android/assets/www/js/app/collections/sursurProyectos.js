...
define(function(require) {
    ...
    return Backbone.Collection.extend({
        ...
        findByName: function(key) {
            var self = this;
            this.surByNameOff = 0;
            var sql = "SELECT DISTINCT RowKey, programaproyectoactividad proyectoprograma FROM sursur WHERE programaproyectoactividad LIKE '%" + key + "%' ORDER BY programaproyectoactividad  LIMIT 0, " + this.surLimit;
