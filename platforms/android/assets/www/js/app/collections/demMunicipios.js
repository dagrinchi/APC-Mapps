...
define(function(require) {
    ...
    return Backbone.Collection.extend({
        ...
        findAll: function() {
            ...
            var self = this;            
            baseapc.execute("select distinct demanda.municipio as item, demanda.municipio as value from demanda where demanda.municipio <> '' order by demanda.municipio", model, function(data) {
                self.reset(data);
                deferred.resolve();
            });
